            ...
            public void onClick(View v) {
                ...
                if(task_name.getText().toString()!=null && task_name.getText().toString().trim().length()!=0 && description.getText().toString()!=null && description.getText().toString().trim().length()!=0){
                    ...
                    try {
                        ...
                        database.execSQL("UPDATE timeSheetValues set Weekend='" + weekend_string + "',Monday='"+ mon_String +"',Tuesday='"+ tue_String +"',Wednesday='"+ wed_String +"',Thursday='"+ thu_String +"',Friday='"+ fri_String +"',Saturday='"+ sat_String +"',Sunday='"+ sun_String +"',Client='"+ client_string +"',Project='"+ project_string +"',Task='"+ task_name_string +"'," +
